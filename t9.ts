...
class AddressBookManager {
    ...
    start(): void {
        ...
        while (isActive) {
            ...
            console.log("4. Delete a Contact (UC-4)");
            console.log("5. Exit");
            ...
            switch (choice) {
                ...
                case 4:
                    console.log("\n--- Delete a Contact (UC-4) ---");
                    const deleteFirstName = readlineSync.question("Enter First Name of the contact to delete: ");
                    const deleteLastName = readlineSync.question("Enter Last Name of the contact to delete: ");
                    this.addressBook.deleteContact(deleteFirstName, deleteLastName);
                    break;
