        ...
        while (isActive) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    const cityQuery = readlineSync.question("Enter city name to view people: ");
                    this.addressBookManager.viewPeopleByCityAcrossAddressBooks(cityQuery);
                    break;

                case 6:
                    console.log("\n--- View People by State (UC-9) ---");
                    const stateQuery = readlineSync.question("Enter state name to view people: ");
                    this.addressBookManager.viewPeopleByStateAcrossAddressBooks(stateQuery);
                    break;
