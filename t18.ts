...
class ContactManager {
    ...
    public cityDictionary: { [key: string]: Person[] } = {}; // Key: city name, Value: array of persons in that city
    public stateDictionary: { [key: string]: Person[] } = {}; // Key: state name, Value: array of persons in that state
...
class AddressBook {
    ...
    writeToFile(): void {
        const data = this.contactManager.people.map(person => ({
        ...
        // console.log(`Address Book data written to ${filePath} successfully!`);
    }
}
...
class AddressBookMain {
    ...
    private manageSelectedAddressBook(selectedAddressBook: AddressBook): void {
        ...
        while (isActive) {
            ...
            console.log("6. Sort People by Name");
            console.log("7. Sort People by City");
            console.log("8. Sort People by State");
            console.log("9. Sort People by Zip");
            console.log("10. Save Address Book to File");
            ...
            switch (choice) {
                ...
                case 10:
                    // const filePath = readlineSync.question("Enter the file path to save the address book: ");
                    selectedAddressBook.writeToFile();
                    break;
